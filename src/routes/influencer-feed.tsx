...
function MarkAsTrendButtons({
    ...
    try {
      const res = await fetch("/api/public/hooks/submit-manual", {
        ...
        body: JSON.stringify({
          section,
          url: post.url,
          title: post.caption ? post.caption.slice(0, 200) : post.influencerName,
        }),
      });
  ...
  return (
    <div style={{ display: "flex", gap: 6, padding: "8px 14px", borderTop: "1px solid #f1f1f1" }}>
    ...
    <div className="space-y-8">
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div className="space-y-2">
          <h1 className="font-display text-3xl font-bold sm:text-4xl">Feed Influencer</h1>
